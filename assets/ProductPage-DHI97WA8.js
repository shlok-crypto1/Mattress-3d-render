...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(e,t,n){let r=new Float32Array(So),i=new J(0,1,0);return new Xi({name:`SphericalGaussianBlur`,defines:{n:So,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:zo(),fragmentShader:`
...
`)}var sc=new Y;function cc(e){X._getMatrix(sc,X.workingColorSpace,e);let t=`mat3( ${sc.elements.map(e=>e.toFixed(4))} )`;switch(X.getTransfer(e)){case Ke:return[t,`LinearTransferOETF`];case qe:return[t,`sRGBTransferOETF`];default:return W(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function lc(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}function wu({product:e,backTo:t=`/`,brand:n=`vedasleep`,transitionId:r=null}){return(0,fu.jsx)(Cu,{product:e,brand:n,transitionId:r,backTo:t})}export{Vi as _,fi as a,Xr as c,Er as d,$i as f,Ye as g,f as h,Z as i,Rt as l,gt as m,Ll as n,di as o,Qi as p,ui as r,pn as s,wu as t,Rr as u,q as v,J as y};