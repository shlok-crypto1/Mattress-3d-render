...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}function Nc({product:e}){return(0,kc.jsxs)(`div`,{style:{position:`relative`},children:[(0,kc.jsx)(t,{to:`/`,style:{position:`absolute`,top:18,left:18,zIndex:10,fontSize:12,fontWeight:500,letterSpacing:`0.03em`,color:`#8a8a8e`,textDecoration:`none`,background:`rgba(255,255,255,0.7)`,padding:`6px 12px`,borderRadius:100},children:`← Catalog`}),(0,kc.jsx)(Mc,{product:e})]})}export{Nc as t};