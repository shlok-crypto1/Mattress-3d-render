...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qa(e,t,n){let r=new Float32Array(Na),i=new q(0,1,0);return new li({name:`SphericalGaussianBlur`,defines:{n:Na,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ja(){return new li({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Xa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ya(){return new li({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xa(),fragmentShader:`
	...
	`}var Za=class extends Nt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Jr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Cs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ws(e,t){let n=Cs[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ts=new q;function Es(){return Y.getLuminanceCoefficients(Ts),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ts.x.toFixed(4)}, ${Ts.y.toFixed(4)}, ${Ts.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}function Zc({product:n,backTo:r=`/`,brand:i=`vedasleep`,transitionId:o=null}){let s=i===`foamico`,c=e(o);return(0,$.jsxs)(`div`,{style:{position:`relative`},children:[(0,$.jsx)(t,{to:r,style:{position:`absolute`,top:18,left:18,zIndex:10,fontSize:12,fontWeight:500,letterSpacing:`0.03em`,color:s?`#b5b5b5`:`#8a8a8e`,textDecoration:`none`,background:s?`rgba(255,255,255,0.08)`:`rgba(255,255,255,0.7)`,padding:`6px 12px`,borderRadius:100,...o?a(c,190):null},children:`← Catalog`}),(0,$.jsx)(Xc,{product:n,brand:i,transitionId:o})]})}export{Zc as t};