...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ba(){return new ai({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ha(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Va(){return new ai({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ha(),fragmentShader:`
	...
	`}var Ua=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Wr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}function Pc({product:e,backTo:n=`/`,brand:r=`vedasleep`}){let i=r===`foamico`;return(0,kc.jsxs)(`div`,{style:{position:`relative`},children:[(0,kc.jsx)(t,{to:n,style:{position:`absolute`,top:18,left:18,zIndex:10,fontSize:12,fontWeight:500,letterSpacing:`0.03em`,color:i?`#b5b5b5`:`#8a8a8e`,textDecoration:`none`,background:i?`rgba(255,255,255,0.08)`:`rgba(255,255,255,0.7)`,padding:`6px 12px`,borderRadius:100},children:`← Catalog`}),(0,kc.jsx)(Nc,{product:e,brand:r})]})}export{Pc as t};