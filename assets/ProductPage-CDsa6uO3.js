...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}function Zc({product:e,backTo:t=`/`,brand:n=`vedasleep`,transitionId:i=null}){let o=n===`foamico`,c=a(i);return(0,$.jsxs)(`div`,{style:{position:`relative`},children:[(0,$.jsx)(r,{to:t,style:{position:`absolute`,top:18,left:18,zIndex:10,fontSize:12,fontWeight:500,letterSpacing:`0.03em`,color:o?`#b5b5b5`:`#8a8a8e`,textDecoration:`none`,background:o?`rgba(255,255,255,0.08)`:`rgba(255,255,255,0.7)`,padding:`6px 12px`,borderRadius:100,...i?s(c,190):null},children:`← Catalog`}),(0,$.jsx)(Xc,{product:e,brand:n,transitionId:i})]})}export{Zc as t};