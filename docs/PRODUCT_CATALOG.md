...
| Natural composition | **Natural is a different build, not this stack thinned.** **Six bands: cover → convoluted comfort foam → perforated natural latex → rebonded chip core → support foam → bonded base.** The blue and purple comfort foams of the standard stack are gone rather than merely thinner, and the latex takes their place. Read from `Layers/ULTIMA NATURAL.png`. Band count, order, type and surface are confirmed by that render; the per-band thicknesses are eyeballed placeholders until a foam split is given. | Confirmed (product owner, 2026-08-31 — go by the filename, disregard the woven tag) |
...
| Natural composition | **Natural is a different build, not this stack thinned.** **Four bands: cover → convoluted comfort foam → perforated natural latex → bonded base.** The shortest stack of any FOAMICO grade, and the latex slab is over half the mattress. Read from `Layers/RIVA NATURAL.png`. Band count, order, type and surface are confirmed by that render; the per-band thicknesses are eyeballed placeholders until a foam split is given. | Confirmed (product owner, 2026-08-31 — go by the filename, disregard the woven tag) |
